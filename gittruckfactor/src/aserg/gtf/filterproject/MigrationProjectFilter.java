...
public class MigrationProjectFilter extends ProjectFilter {
	...
	public MigrationProjectFilter(List<ProjectInfo> projects, int type, float percFilesThreshold, int nCommitsThreshold, ProjectInfoDAO piDAO) throws Exception {
		super(projects, ("*MIGRATION-" + (type==1?"BIGGEST*":"FIRSTEST*")), piDAO);
		this.type = type;
		if (type!= 1 && type != 2)
